...
return new class extends Migration
{
    ...
    {
        DB::statement(<<<SQL
CREATE TABLE `comet_club_representatives` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_representative` (`club_fifa_id`,`person_fifa_id`),
...
SQL
    ...
    {
        DB::statement('DROP TABLE IF EXISTS `comet_club_representatives`');
    }
};
