...
echo "=== Dropping comet_cases from all tenants ===\n\n";
...
foreach ($tenants as $tenant) {
    ...
    try {
        ...
        // Get all FKs that reference comet_cases
        ...
        // Drop table
        DB::connection('tenant')->statement('DROP TABLE IF EXISTS comet_cases');
        echo "  ✓ Dropped comet_cases table\n";
