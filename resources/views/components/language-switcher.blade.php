<div x-data="{ open: false }" class="relative">
    ...
    <div x-show="open"
        ...
        @foreach(['de' => 'Deutsch', 'en' => 'English', 'hr' => 'Hrvatski'] as $locale => $name)
        <a href="{{ route('language.switch', $locale) }}"
           class="flex items-center justify-between px-4 py-2 hover:bg-gray-800 transition-colors {{ app()->getLocale() === $locale ? 'bg-gray-800' : '' }}">
