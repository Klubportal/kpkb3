...
@php
    // Get Club Settings for colors and branding
    $clubSettings = app(\App\Settings\Tenant\ClubSettings::class);
    $primaryColor = $settings->primary_color ?? $clubSettings->primary_color ?? '#dc2626';
@endphp

@section('hero')
<section class="text-white py-16" style="background: linear-gradient(to right, {{ $primaryColor }}, {{ $primaryColor }}dd);">
    <div class="container mx-auto px-4">
        <h1 class="text-4xl font-bold mb-4">Senioren</h1>
...
<div class="space-y-8">
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        <h2 class="text-2xl font-bold mb-4 text-blue-600">Mannschaftsinfo</h2>
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex items-center gap-2 flex-1">
                                ...
                                @endif
                                <span class="font-semibold">{{ $match->team_name_home }}</span>
                            </div>
                            ...
                            <div class="flex items-center gap-2 flex-1 justify-end">
                                <span class="font-semibold">{{ $match->team_name_away }}</span>
