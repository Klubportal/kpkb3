    ...
    <div class="space-y-8">
        ...
        <div class="bg-card rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <h3 class="font-semibold text-header mb-2">Trainer</h3>
                    <p class="text-gray-500">Wird geladen...</p>
                </div>
                <div>
                    <h3 class="font-semibold text-header mb-2">Spielklasse</h3>
                    <p class="text-gray-500">Wird geladen...</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex items-center gap-2 flex-1">
                                    ...
                                    @endif
                                    <span class="font-semibold text-header">{{ $match->team_name_home }}</span>
                                </div>
                                ...
                                <div class="flex items-center gap-2 flex-1 justify-end">
                                    <span class="font-semibold text-header">{{ $match->team_name_away }}</span>
