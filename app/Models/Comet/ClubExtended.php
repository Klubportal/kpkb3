...
class ClubExtended extends Model
{
    ...
    {
        return $this->hasMany(CometMatch::class, 'team_fifa_id_home', 'club_fifa_id');
    }
    ...
    {
        return $this->hasMany(CometMatch::class, 'team_fifa_id_away', 'club_fifa_id');
    }
    ...
    {
        return CometMatch::where('team_fifa_id_home', $this->club_fifa_id)
            ->orWhere('team_fifa_id_away', $this->club_fifa_id);
    }
