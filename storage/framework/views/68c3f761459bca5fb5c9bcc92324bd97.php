        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="mt-2 text-3xl font-bold text-gray-900"><?php echo e($tenants->count()); ?></div>
                </div>
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="text-sm font-medium text-gray-500">Mit COMET Sync</div>
                    <div class="mt-2 text-3xl font-bold text-blue-600">
                        <?php echo e($tenants->filter(fn($t) => $t->comet_stats)->count()); ?>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    <?php echo e($tenant->domains->first()?->domain ?? 'Keine Domain'); ?>

                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?php if(isset($tenant->data['club_fifa_id'])): ?>
                                <span class="px-2 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded">
                                    <?php echo e($tenant->data['club_fifa_id']); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?php if($tenant->comet_stats): ?>
                                <div class="text-xs space-y-1">
                                    <div>🏆 <?php echo e($tenant->comet_stats['competitions']); ?> Competitions</div>
                                    <div>⚽ <?php echo e($tenant->comet_stats['matches']); ?> Matches</div>
                                    <div>📊 <?php echo e($tenant->comet_stats['rankings']); ?> Rankings</div>
                                </div>
                                <?php else: ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?php echo e($tenant->created_at->format('d.m.Y H:i')); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="http://<?php echo e($tenant->domains->first()?->domain); ?>"
                                   target="_blank"
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                                ...
                                <div class="mt-2">
                                    <a href="<?php echo e(route('admin.tenants.create')); ?>" class="text-blue-600 hover:text-blue-800">
...
<?php /**PATH C:\xampp\htdocs\kpkb3\resources\views\admin\tenants\index.blade.php ENDPATH**/ ?>