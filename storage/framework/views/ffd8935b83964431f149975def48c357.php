...
<?php $__env->startSection('title', 'Klubportal - Vereinsverwaltung für Fußballvereine'); ?>
...
<section id="vereine" class="py-16 bg-white rounded-2xl shadow-lg">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="http://<?php echo e($tenant->domains->first()->domain); ?>" class="block bg-gradient-to-br from-gray-50 to-white p-6 rounded-xl border-2 border-gray-200 hover:border-blue-500 hover:shadow-xl transition">
            <h3 class="text-xl font-bold text-gray-800 mb-2"><?php echo e($tenant->name); ?></h3>
            <p class="text-sm text-gray-600 mb-4"><?php echo e($tenant->domains->first()->domain); ?></p>
...
<?php echo $__env->make('central-frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\kpkb3\resources\views\central-frontend\home.blade.php ENDPATH**/ ?>