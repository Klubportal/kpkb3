...
<head>
    ...
    <title><?php echo e($title ?? 'Klubportal - Die moderne Vereinsverwaltung'); ?></title>
        ...
        <div class="container mx-auto">
            <div class="flex-1">
                <a href="/" class="btn btn-ghost text-xl">
                    <img src="<?php echo e(asset('images/logo.svg')); ?>" alt="Klubportal" class="h-10">
    ...
    <footer class="bg-secondary text-white mt-20">
        <div class="container mx-auto px-4 py-12">
            ...
            <div class="border-t border-white/20 mt-8 pt-8 text-center text-sm opacity-60">
                <p>&copy; <?php echo e(date('Y')); ?> Klubportal. Alle Rechte vorbehalten.</p>
            </div>
        </div>
    </footer>
...
<?php /**PATH C:\xampp\htdocs\kpkb3\resources\views\components\layouts\central\guest.blade.php ENDPATH**/ ?>