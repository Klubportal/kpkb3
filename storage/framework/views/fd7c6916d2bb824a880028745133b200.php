                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-2xl font-semibold text-gray-900">
                                        <?php echo e($stats['total_syncs_today']); ?>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-2xl font-semibold text-gray-900">
                                        <?php echo e($stats['successful_syncs_today']); ?>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-2xl font-semibold text-gray-900">
                                        <?php echo e($stats['failed_syncs_today']); ?>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-2xl font-semibold text-gray-900">
                                        <?php echo e(number_format($stats['last_24h_records'])); ?>
            ...
            <div class="bg-white shadow rounded-lg">
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex justify-between items-center">
                        ...
                        <a href="<?php echo e(route('admin.sync.history')); ?>" class="text-blue-600 hover:text-blue-800 text-sm">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody id="sync-table-body" class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $recentSyncs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sync): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                        <?php echo e($sync->sync_type); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <?php echo e(number_format($sync->records_inserted ?? 0)); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <?php echo e(number_format($sync->records_updated ?? 0)); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <?php echo e($sync->duration_seconds ? round($sync->duration_seconds, 2) . 's' : '-'); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e($sync->started_at->diffForHumans()); ?>
...
<?php /**PATH C:\xampp\htdocs\kpkb3\resources\views\admin\sync\index.blade.php ENDPATH**/ ?>