        ...
        <div class="border-b border-gray-200 py-2">
            <div class="flex justify-between items-center text-sm">
                <div class="flex items-center space-x-4">
                    <span class="text-header"><?php echo e(now()->format('d.m.Y')); ?></span>
                </div>
                <div class="flex items-center space-x-4">
                    <?php if($settings->facebook_url): ?>
                        <a href="<?php echo e($settings->facebook_url); ?>" target="_blank" class="text-header hover:text-primary transition">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                        </a>
                    <?php endif; ?>
                    <?php if($settings->instagram_url): ?>
                        <a href="<?php echo e($settings->instagram_url); ?>" target="_blank" class="text-header hover:text-primary transition">
                    ...
                    <?php if($settings->youtube_url): ?>
                        <a href="<?php echo e($settings->youtube_url); ?>" target="_blank" class="text-header hover:text-primary transition">
            ...
            <div class="flex justify-between items-center">
                ...
                <a href="<?php echo e(url('/')); ?>" class="flex items-center space-x-3">
                    <?php if($settings->logo): ?>
                        <img src="<?php echo e(asset('storage/' . $settings->logo)); ?>" alt="<?php echo e($settings->website_name); ?>" class="h-16 w-auto">
                    <?php else: ?>
                        <div class="h-16 w-16 bg-primary rounded-full flex items-center justify-center">
                            <span class="text-white font-bold text-2xl"><?php echo e(substr($settings->website_name ?? 'FC', 0, 2)); ?></span>
                        </div>
                    <?php endif; ?>
                    <span class="text-2xl font-bold text-header hidden md:block"><?php echo e($settings->website_name); ?></span>
                </a>

                <!-- Desktop Menu -->
                <div class="hidden lg:flex items-center space-x-8">
                    <a href="<?php echo e(url('/')); ?>" class="text-header hover:text-primary transition font-semibold">Home</a>
                    <a href="<?php echo e(url('/news')); ?>" class="text-header hover:text-primary transition font-semibold">News</a>
...
<?php /**PATH C:\xampp\htdocs\kpkb3\resources\views/templates/fcbm/partials/navbar.blade.php ENDPATH**/ ?>